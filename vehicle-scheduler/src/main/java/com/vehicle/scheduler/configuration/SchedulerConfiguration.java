package com.vehicle.scheduler.configuration;

import com.vehicle.scheduler.quartz.DemoJob01;
import com.vehicle.scheduler.quartz.DemoJob02;
...
@Slf4j
@Configuration
@ComponentScan(basePackages = {"com.vehicle.scheduler"})
