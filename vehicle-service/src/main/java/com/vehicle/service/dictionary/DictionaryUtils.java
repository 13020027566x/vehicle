...
public class DictionaryUtils {
     ...
     * 用户状态-启用ID.
     */
    public static String YHZT_QY_ID() {
     ...
     * 用户状态-停用ID.
     */
    public static String YHZT_TY_ID() {
     ...
     * 机构类型-其他ID.
     */
    public static String JGLX_QT_ID() {
     ...
     * 日志类型-登录登出ID.
     */
    public static String RZLX_DLDC_ID() {
     ...
     * 日志类型-启用停用ID.
     */
    public static String RZLX_QYTY_ID() {
     ...
     * 操作类型-登录ID.
     */
    public static String CZLX_DL_ID() {
     ...
     * 操作类型-登出ID.
     */
    public static String CZLX_DC_ID() {
     ...
     * 操作类型-启用ID.
     */
    public static String CZLX_QY_ID() {
     ...
     * 操作类型-停用ID.
     */
    public static String CZLX_TY_ID() {
