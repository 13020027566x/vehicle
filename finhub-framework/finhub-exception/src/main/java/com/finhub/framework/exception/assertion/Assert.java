...
import com.finhub.framework.exception.WrapMessageException;
...
public interface Assert {
    ...
    default BaseException newException(CodeEnum codeEnum, String message) {
        throw new BaseException(codeEnum, message);
    }
    ...
    default BaseException newException(CodeEnum codeEnum, Throwable cause) {
        throw new BaseException(codeEnum, cause);
    }
    ...
    /**
     * 创建异常.
     * 先使用 {@code errMsg} 创建一个 {@link com.finhub.framework.exception.WrapMessageException} 异常,
    ...
    /**
     * 创建异常.
     * 先使用 {@code errMsg} 和 {@code t} 创建一个 {@link com.finhub.framework.exception.WrapMessageException} 异常,
     * 再以入参的形式传给 {{{@link #newException(Throwable, Object...)}}}, 作为最后创建的异常的 cause 属性.
     *
     * @param errMsg 自定义的错误信息
     * @param args
