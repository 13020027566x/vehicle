package com.finhub.framework.common.service.aspect;
...
@Slf4j
@Aspect
public class ServiceCostLogAspect extends AbstractAspect {

    private static final String LOG_ASPECT_MODULE = "Service";
     ...
     * 该方法就是一个标识，不进行调用
     */
    @Pointcut(SERVICE_ASPECT_POINTCUT)
