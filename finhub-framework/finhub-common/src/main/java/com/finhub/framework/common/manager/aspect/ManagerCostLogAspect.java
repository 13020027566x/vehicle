package com.finhub.framework.common.manager.aspect;
...
@Slf4j
@Aspect
public class ManagerCostLogAspect extends AbstractAspect {

    private static final String LOG_ASPECT_MODULE = "Manager";
     ...
     * 该方法就是一个标识，不进行调用
     */
    @Pointcut(MANAGER_ASPECT_POINTCUT)
