 ...
 */
@Slf4j
public class KmsDataKeyPropertyDetector extends DefaultPropertyDetector implements AvailableStringEncryptor {

    public static final String PREFIX = "KMS-DENC(";

    public static final String SUFFIX = ")";

    private final StringEncryptor stringEncryptor;

    public KmsDataKeyPropertyDetector(StringEncryptor stringEncryptor) {
        super(PREFIX, SUFFIX);
