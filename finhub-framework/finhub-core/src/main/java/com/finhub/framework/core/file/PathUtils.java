...
public class PathUtils {
    ...
    public static String getPath(Class clazz) {
        String path = clazz.getResource(StrConstants.S_EMPTY).getPath();
        return new File(path).getAbsolutePath();
    }

    public static String getPath(Object object) {
        String path = object.getClass().getResource(StrConstants.S_EMPTY).getPath();
        return new File(path).getAbsolutePath();
    }
    ...
    public static String getRootClassPath() {
        if (rootClassPath == null) {
            try {
                String path = PathUtils.class.getClassLoader().getResource(StrConstants.S_EMPTY).toURI().getPath();
                rootClassPath = new File(path).getAbsolutePath();
            } catch (Exception e) {
                String path = PathUtils.class.getClassLoader().getResource(StrConstants.S_EMPTY).getPath();
                rootClassPath = new File(path).getAbsolutePath();
            }
        }
    ...
    public static String getPackagePath(Object object) {
        ...
        return p != null ? p.getName().replaceAll("\\.", "/") : StrConstants.S_EMPTY;
    }

    public static File getFileFromJar(String file) {
        throw new UtilException("Not finish. Do not use this method.");
    }
