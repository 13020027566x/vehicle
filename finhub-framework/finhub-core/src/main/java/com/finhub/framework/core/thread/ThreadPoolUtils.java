...
public class ThreadPoolUtils {
    ...
    private static ExecutorService executor = new ThreadPoolExecutor(3, 10, 3, TimeUnit.SECONDS,
    ...
    public static void restart() {
        ...
        executor = new ThreadPoolExecutor(3, 10, 3, TimeUnit.SECONDS,
            new ArrayBlockingQueue<>(4), new ThreadPoolExecutor.DiscardOldestPolicy());
    }
    ...
    public static ExecutorService newExecutor(int threadSize) {
        return new ThreadPoolExecutor(3, threadSize, 3, TimeUnit.SECONDS,
            new ArrayBlockingQueue<>(4), new ThreadPoolExecutor.DiscardOldestPolicy());
    }
    ...
    public static ExecutorService newExecutor() {
        return new ThreadPoolExecutor(3, 10, 3, TimeUnit.SECONDS,
            new ArrayBlockingQueue<>(4), new ThreadPoolExecutor.DiscardOldestPolicy());
    }
    ...
    public static ExecutorService newSingleExecutor() {
        return new ThreadPoolExecutor(1, 1, 3, TimeUnit.SECONDS,
            new ArrayBlockingQueue<>(4), new ThreadPoolExecutor.DiscardOldestPolicy());
    }
    ...
    public static void printAllStackTraces() {
        for (Map.Entry<Thread, StackTraceElement[]> entry : Thread.getAllStackTraces().entrySet()) {
            ...
            stackTrace.append("Thread name : ").append(thread.getName());
