package com.finhub.framework.core.security;
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            BusinessResponseEnum.COMMON_ERROR.newException(HttpStatus.BAD_REQUEST.getStatusCode(), "生成token失败");
//        }
        return source;
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            BusinessResponseEnum.COMMON_ERROR.newException(HttpStatus.BAD_REQUEST.getStatusCode(), "解析token失败");
//        }
    }
}
