...
import com.finhub.framework.core.object.ObjectUtils;
...
public class Func {
    ...
    public static boolean contains(final Object obj, final Object element) {
        return ObjectUtils.contains(obj, element);
    }
    ...
    public static boolean isBlank(String str) {
        return null == str || StrUtil.equals(StrConstants.S_EMPTY, str.trim());
    }
    ...
    public static boolean isEmpty(final Object obj) {
        ...
        if (obj instanceof String) {
            if (StrUtil.equals(StrConstants.S_EMPTY, obj.toString().trim())) {
                return true;
            }
    ...
    public static String toStr(final Object str) {
        return toStr(str, StrConstants.S_EMPTY);
    }
    ...
    public static String encodeUrl(final String url) {
        return URLUtil.encode(url, CharsetUtils.DEFAULT_CHARSET);
    }

    public static String decodeUrl(final String url) {
        return URLUtil.decode(url, CharsetUtils.UTF_8);
    }
    ...
    public static void builder(final StringBuilder sb, final String... strs) {
        if (isNull(sb) || ArrayUtil.isEmpty(strs)) {
            return;
        }
        for (String str : strs) {
            sb.append(str);
