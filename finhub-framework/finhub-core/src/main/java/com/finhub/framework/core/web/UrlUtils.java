...
public class UrlUtils {
     ...
     * @return URL
     * @throws com.finhub.framework.exception.UtilException MalformedURLException
     */
    ...
    public static String formatUrl(String url) {
        ...
        if (url.startsWith(StrConstants.S_HTTP_PREFIX) || url.startsWith(StrConstants.S_HTTPS_PREFIX)) {
            return url;
        }
        return "http://" + url;
    }
     ...
     * @param charset 编码
     * @return 编码后的URL
     * @throws com.finhub.framework.exception.UtilException UnsupportedEncodingException
     */
     ...
     * @param uriStr URI路径
     * @return path
     * @throws com.finhub.framework.exception.UtilException URISyntaxException
     */
    ...
    public static String decodeURLComponent(String raw) {
        try {
            return URLDecoder.decode(raw, CharsetUtils.DEFAULT_ENCODE);
        } catch (UnsupportedEncodingException e) {
            return raw;
        }
    }
    ...
    public static String encodeURLComponent(String raw) {
        try {
            return URLEncoder.encode(raw, CharsetUtils.DEFAULT_ENCODE);
        } catch (UnsupportedEncodingException e) {
            return raw;
        }
    }
