...
public class TimeUtils {
    ...
    /**
     * {@link java.time.format.DateTimeFormatter}是线程安全的, 所以可以缓存起来
     */
    ...
    /**
     * {@link java.time.LocalTime} 转换为 {@link java.util.Date}
     *
     * @param localTime
     * @return
     */
    ...
    /**
     * timestamp(时间戳) 转换为 {@link java.time.LocalDateTime}
     *
     * @param timestamp 时间戳
     * @return
     */
    ...
    /**
     * timestamp(时间戳) 转换为 {@link java.time.LocalDate}
     *
     * @param timestamp 时间戳
     * @return
     */
    ...
    /**
     * timestamp(时间戳) 转换为 {@link java.time.LocalTime}
     *
     * @param timestamp 时间戳
     * @return
     */
    ...
    /**
     * 根据 {@link java.time.LocalDate} 获取对应 零点 的秒数. 时区默认使用的是系统当前时区.
     *
     * @param localDate
     * @return
     */
    ...
    /**
     * 根据 {@link java.time.LocalTime} 获取对应 当天零点 的秒数. 时区默认使用的是系统当前时区.
     *
     * @param localTime
     * @return
     */
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 获取对应的秒数. 时区默认使用的是系统当前时区.
     *
     * @param localDateTime
     * @return
     */
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 获取对应的毫秒数. 时区默认使用的是系统当前时区.
     *
     * @param localDateTime
     * @return
     */
    ...
    /**
     * 根据 {@link java.time.LocalTime} 获取对应 当天零点 的毫秒数. 时区默认使用的是系统当前时区.
     *
     * @param localTime
     * @param timeZone
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDate} 获取对应 零点 的毫秒数. 时区默认使用的是系统当前时区.
     *
     * @param localDate
     * @param timeZone
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 获取指定时区对应的秒数.
     *
     * @param localDateTime
     * @param timeZone      指定时区
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 获取指定时区对应的毫秒数.
     *
     * @param localDateTime
     * @param timeZone      指定时区
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDate} 和 {@link java.time.ZoneId} 时区, 获取指定时区 零点 对应的秒数.
     *
     * @param localDate
     * @param zoneId
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDate} 和 {@link java.time.ZoneId} 时区, 获取指定时区 零点 对应的毫秒数.
     *
     * @param localDate
     * @param zoneId
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalTime} 和 {@link java.time.ZoneId} 时区, 获取指定时区 当天零点 对应的秒数.
     *
     * @param localTime
     * @param zoneId
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalTime} 和 {@link java.time.ZoneId} 时区, 获取指定时区 当天零点 对应的毫秒数.
     *
     * @param localTime
     * @param zoneId
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 和 {@link java.time.ZoneId} 时区, 获取指定时区对应的秒数.
     *
     * @param localDateTime
     * @param zoneId    时区
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 和 {@link java.time.ZoneId} 时区, 获取指定时区对应的毫秒数.
     *
     * @param localDateTime
     * @param zoneId    时区
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDate} 和 {@link java.time.ZoneOffset} 时区偏移量, 获取指定时区 零点 对应的秒数.
     *
     * @param localDate
     * @param zoneOffset
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDate} 和 {@link java.time.ZoneOffset} 时区偏移量, 获取指定时区 零点 对应的毫秒数.
     *
     * @param localDate
     * @param zoneOffset
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalTime} 和 {@link java.time.ZoneOffset} 时区偏移量, 获取指定时区 当天零点 对应的秒数.
     *
     * @param localTime
     * @param zoneOffset
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalTime} 和 {@link java.time.ZoneOffset} 时区偏移量, 获取指定时区 当天零点 对应的毫秒数.
     *
     * @param localTime
     * @param zoneOffset
     * @return
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 和 {@link java.time.ZoneOffset} 时区偏移量, 获取指定时区对应的秒数.
     *
     * @param localDateTime
    ...
    /**
     * 根据 {@link java.time.LocalDateTime} 和 {@link java.time.ZoneOffset} 时区偏移量, 获取指定时区对应的毫秒数.
     *
     * @param localDateTime
     * @param zoneOffset    时区偏移量
     * @return
    ...
    public static LocalTime parseTime(String time, String pattern) {
        MessageResponseEnum.DATE_NOT_NULL.assertNotEmpty(time);
    ...
    private static String checkNotEmpty(String time, boolean nullable) {
        ...
        if (!nullable) {
            MessageResponseEnum.DATE_NOT_NULL.assertFail(time);
        }
    ...
    /**
     * 克隆一个全新的{@link java.time.LocalDateTime}
     * @param dateTime
     * @return
     */
    ...
    /**
     * 克隆一个全新的{@link java.time.LocalDate}
     * @param date
     * @return
     */
    ...
    /**
     * 克隆一个全新的{@link java.time.LocalTime}
     * @param time
     * @return
     */
     ...
     * @param dayOfWeek {@link java.time.DayOfWeek}
    ...
    /**
     * 从缓存中获取{@link java.time.format.DateTimeFormatter}
     * @param pattern
     * @return
     */
    private static DateTimeFormatter getFormatter(String pattern) {
        MessageResponseEnum.PATTERN_NOT_NULL.assertNotEmpty(pattern);
    ...
    public static long getBetweenSeconds(LocalDateTime startDateTime, LocalDateTime endDateTime) {
        MessageResponseEnum.DATETIME_NOT_NULL.assertNotNull(startDateTime);
        MessageResponseEnum.DATETIME_NOT_NULL.assertNotNull(endDateTime);
    ...
    public static long getBetweenSeconds(LocalTime startTime, LocalTime endTime) {
        MessageResponseEnum.TIME_NOT_NULL.assertNotNull(startTime);
        MessageResponseEnum.TIME_NOT_NULL.assertNotNull(endTime);
