package com.finhub.framework.pay.configuration;
...
@Slf4j
@Configuration
@ConditionalOnProperty(name = "vehicle.pay.enabled", matchIfMissing = true)
@EnableConfigurationProperties({WxMaProperties.class, WxPayProperties.class})
public class PayAutoloadConfiguration {
    ...
    @Autowired
    public PayAutoloadConfiguration(WxMaProperties wxMaProperties, WxPayProperties wxPayProperties) {
