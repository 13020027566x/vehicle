...
<mapper namespace="${conf.daoPackageName}.${table.lowerCamelName}.${table.className}DAO">
    <resultMap id="${table.className}ResultMap" type="${conf.daoPackageName}.${table.lowerCamelName}.po.${table.className}PO">
