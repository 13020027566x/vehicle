...
public enum PrimitiveType {
    ...
    /**
     * Adds support of a small number of "well-known" types, specifically for Joda
     * lib.
     */
    ...
    /**
     * Alternative names for primitive types that have to be supported for backward
     * compatibility.
     */
    ...
    static {
        ...
        addKeys(keyClasses, STRING, String.class.getName(), String.class.getSimpleName(), Character.class.getName(),
        ...
        addKeys(keyClasses, INT, Integer.class.getName(), Integer.class.getSimpleName(), Integer.TYPE.getName(),
            Short.class.getName(),
            Short.TYPE.getName());
        ...
        addKeys(baseClasses, DATE_TIME, java.util.Date.class, Calendar.class);
     ...
     * class qualified names prefixes to be considered as "system" types
     *
     * @return Mutable set of class qualified names prefixes to be considered as
     * "system" types
     * @since 2.0.6
     */
     ...
     * class qualified names NOT to be considered as "system" types
     *
     * @return Mutable set of class qualified names NOT to be considered as "system"
     * types
     * @since 2.0.6
     */
    ...
    public static PrimitiveType fromTypeAndFormat(String type, String format) {
        ...
        return fromName(datatypeMappings.get(String.format("%s_%s", StringUtils.isNotEmpty(type) ? "" : type,
            StringUtils.isEmpty(format) ? "" : format)));
    }
    ...
    /**
     * Convenience method to map LocalTime to string primitive with rfc3339 format
     * partial-time. See
