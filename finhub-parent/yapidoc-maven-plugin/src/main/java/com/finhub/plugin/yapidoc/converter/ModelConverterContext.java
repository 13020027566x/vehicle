...
public interface ModelConverterContext {
    ...
    /**
     * needs to be called whenever a Model is defined which can be referenced from
    ...
    /**
     * needs to be called whenever a Schema is defined which can be referenced from
     * another Model or Property
     *
     * @param name     the name of the model
     * @param model    the Model
     ...
     * @return a Model representation of the Class. Any referenced models will be
     * defined already.
     */
