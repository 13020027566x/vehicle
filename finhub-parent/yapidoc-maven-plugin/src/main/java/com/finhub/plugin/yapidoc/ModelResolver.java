...
import com.finhub.plugin.yapidoc.converter.ModelConverter;
import com.finhub.plugin.yapidoc.converter.ModelConverterContext;
import com.finhub.plugin.yapidoc.models.media.ArraySchema;
import com.finhub.plugin.yapidoc.models.media.MapSchema;
...
import static com.finhub.plugin.yapidoc.utils.DocUtils.genericityContentType;
import static com.finhub.plugin.yapidoc.utils.DocUtils.genericityCount;
...
public class ModelResolver implements ModelConverter {
    ...
    public ModelResolver(com.finhub.plugin.yapidoc.SourceBuilder sourceBuilder) {
    ...
    public Schema resolve(AnnotatedType annotatedType, ModelConverterContext context, Iterator<ModelConverter> chain) {
        ...
        try {
            ...
            targetClass = com.finhub.plugin.yapidoc.SourceBuilder.INSTANCE.getBuilder().getClassByName("java.lang.Object");
        }
        ...
        if (targetClass.isA(Map.class.getName())) {
            ...
            mapSchema.addProperties("", schema);
			/*
			...
			*/
			...
			schema.setType(PrimitiveType.OBJECT.getCommonName());
			arraySchema.addProperties(targetClass.getName()+"<"+javaType.getValue()+">", schema);
			*/
            schema = arraySchema;
        }
            ...
            if (genericityContentType != null && ("T".equals(field.getType().getGenericFullyQualifiedName())
                ...
                if (DocUtils.isList(genericityContentType.getBinaryName())) {
                    ...
                    if (!DocUtils.isPrimitive(findName(genericityContentType))) {
                        ...
                        typeSchema.setType(
                            Optional.ofNullable(primitiveType).orElse(PrimitiveType.OBJECT).getCommonName());
