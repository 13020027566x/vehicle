...
import static com.finhub.plugin.yapidoc.constants.SpringMvcConstants.METHOD_MAP;
import static com.finhub.plugin.yapidoc.constants.SpringMvcConstants.REQUEST_BODY_ALL;
import static com.finhub.plugin.yapidoc.constants.SpringMvcConstants.REQUEST_MAPPING;
import static com.finhub.plugin.yapidoc.constants.SpringMvcConstants.REQUEST_MAPPING_FULLY;
...
public final class DocUtils {
    ...
    public static boolean isRequired(JavaField field) {
        ...
        for (JavaAnnotation annotation : annotations) {
            ...
            if (fullyQualifiedName.startsWith("jakarta.validation")) {
                isRequired = true;
            }
        }
        return isRequired;
