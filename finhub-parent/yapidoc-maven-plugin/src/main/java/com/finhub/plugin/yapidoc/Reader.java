...
import com.finhub.plugin.yapidoc.constants.RequestMethod;
...
import com.finhub.plugin.yapidoc.utils.DocUtils;
import com.finhub.plugin.yapidoc.utils.Json;
import com.finhub.plugin.yapidoc.utils.QdoxUtils;
...
import static com.finhub.plugin.yapidoc.constants.HtmlRex.HTML_P_PATTERN;
import static com.finhub.plugin.yapidoc.constants.SpringMvcConstants.REQUEST_BODY_FULLY;
import static com.finhub.plugin.yapidoc.utils.DocUtils.getRequestMappingMethod;
import static com.finhub.plugin.yapidoc.utils.DocUtils.getRequestMappingUrl;
import static com.finhub.plugin.yapidoc.utils.DocUtils.isContentBody;
import static com.finhub.plugin.yapidoc.utils.DocUtils.isRequestMapping;
import static com.finhub.plugin.yapidoc.utils.RefUtils.constructRef;
...
public class Reader {
    ...
    private Paths paths;
    private com.finhub.plugin.yapidoc.SourceBuilder sourceBuilder;
    ...
    public Reader() {
        ...
        this.sourceBuilder = com.finhub.plugin.yapidoc.SourceBuilder.INSTANCE;
        paths = new Paths();
    ...
    public Reader(OpenAPI openAPI, com.finhub.plugin.yapidoc.SourceBuilder sourceBuilder) {
        this.openAPI = openAPI;
        paths = new Paths();
        components = new Components();
    ...
    public Operation parseMethod(JavaMethod javaMethod, boolean deprecated, String tag) {
        ...
        //mediaType.schema(schemaMap.values().stream().findFirst().orElse(null));
            ...
            if (DocUtils.isPrimitive(parameter.getType().getBinaryName())) {
                ...
                for (String s : stringSchemaMap.keySet()) {
                    ...
                    properties.forEach((k, v) -> {
                        ...
                        String desc = StringUtils.isEmpty(paramDesc.get(parameter.getName())) ? ""
                            : paramDesc.get(parameter.getName()) + "，";
                        inputParameter.setDescription(desc + (v == null ? "" : v.getDescription()));
                        operation.addParametersItem(inputParameter);
                    });
