package com.finhub.plugin.yapidoc.yapi.utils;
...
public class HttpClientUtil {
    ...
    private static void init() throws Exception {
        ...
        // 支持TLSv1.2协议
        Registry<ConnectionSocketFactory> tlsRegistry = RegistryBuilder.<ConnectionSocketFactory>create()
        ...
        tlsClient = HttpClients.custom().setConnectionManager(tlsCM).setDefaultRequestConfig(requestConfig).build();
    }
     ...
     * @throws java.io.IOException
     */
    public HttpPost getHttpPost(String body, String url, String accept, String contentType, String charset)
        throws IOException {
        HttpPost httpPost = new HttpPost(url);
        if (accept != null) {
            httpPost.setHeader("Accept", accept);
     ...
     * @throws java.io.IOException
     */
    public HttpPost getHttpPost(Map<String, String> params, String url, String accept, String contentType,
    ...
    private static class StringResponseHandler implements ResponseHandler<String> {
        ...
        public String handleResponse(HttpResponse response) throws ClientProtocolException, IOException {
            ...
            if (entity != null) {
                return (charset == null) ? EntityUtils.toString(entity) : EntityUtils.toString(entity, charset);
            } else {
                return null;
            }
        }
