...
import com.finhub.plugin.yapidoc.test.res.BasicFieldsResource;
import com.finhub.plugin.yapidoc.test.res.DuplicatedOperationIdResource;
import com.finhub.plugin.yapidoc.test.res.DuplicatedOperationMethodNameResource;
import com.finhub.plugin.yapidoc.test.res.EnhancedResponsesResource;
import com.finhub.plugin.yapidoc.test.res.MuRetController;
import com.finhub.plugin.yapidoc.test.res.ResponseContentWithArrayResource;
import com.finhub.plugin.yapidoc.test.res.TestController;
...
public class ReaderTest {
    ...
    public void test2497() {
        ...
        Operation operation = pathItem.getGet();
        assertNotNull(operation);
        ArraySchema schema = (ArraySchema) operation.getResponses().get("200").getContent().values().iterator().next()
            .getSchema();
