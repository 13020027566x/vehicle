...
import com.finhub.plugin.yapidoc.ModelResolver;
import com.finhub.plugin.yapidoc.converter.AnnotatedType;
import com.finhub.plugin.yapidoc.converter.ModelConverterContextImpl;
import com.finhub.plugin.yapidoc.models.media.ArraySchema;
import com.finhub.plugin.yapidoc.models.media.Schema;
import com.finhub.plugin.yapidoc.test.res.InnerType;
import com.finhub.plugin.yapidoc.test.res.Result;
...
public class ContainerTest extends TestBase {
    ...
    public void testArray() throws Exception {
        ...
        final Schema model = context.resolve(new AnnotatedType(classByName));
